                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-6 mt-4 mt-md-0">
                        ...
                        <div className="d-flex border border-dark text-center" style={{ width: "100px" }}>
                            <span className="w-25 py-1" role="button" onClick={decreaseQty}>-</span>
                            <div className="border border-dark border-top-0 border-bottom-0 w-50 py-1">{quantity}</div>
                            <span className="w-25 py-1" role="button" onClick={increaseQty}>+</span>
                        </div>
                        <button className="btn btn-dark rounded-0 my-3 w-100" onClick={handleAddToCart}>Add To Cart</button>
